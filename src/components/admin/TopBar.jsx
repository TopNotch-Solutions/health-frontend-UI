    ...
    const fetchNotificationCount = async () => {
      ...
      try {
        const response = await fetchJSON(
          `http://13.51.207.99:4000/api/portal/notification/unread-count/${currentUser._id}`,
          "GET"
        );
    ...
    >
      ...
      <Box display="flex" alignItems="center" gap={2}>
        ...
        <div className="user-avatar">
          <Avatar
            alt="User Profile"
            src={currentUser?.profileImage ? `http://13.51.207.99:4000/images/${currentUser.profileImage}` : undefined}
            sx={{
