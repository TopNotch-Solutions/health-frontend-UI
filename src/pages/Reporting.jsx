...
function Reporting() {
  ...
  const handleViewRecords = async (reportType) => {
    ...
    try {
      ...
      switch (reportType) {
        case 'users':
          response = await fetchJSON("https://apihealthconnect.kopanovertex.com/api/app/auth/all-users", "GET");
          ...
          break;
        case 'admins':
          response = await fetchJSON("https://apihealthconnect.kopanovertex.com/api/portal/auth/all-users", "GET");
          if (response.status === true && response.users) {
            data = response.users.map((user, index) => ({
              ...user,
              id: user._id || index,
          ...
          break;
        case 'transactions':
          response = await fetchJSON("https://apihealthconnect.kopanovertex.com/api/app/transaction/all-transactions", "GET");
          ...
          break;
        case 'issues':
          response = await fetchJSON("https://apihealthconnect.kopanovertex.com/api/app/issue/all-issues", "GET");
        ...
        case 'specializations':
          response = await fetchJSON("https://apihealthconnect.kopanovertex.com/api/portal/specialization/all-specializations", "GET");
          ...
          break;
        case 'ailments':
          response = await fetchJSON("https://apihealthconnect.kopanovertex.com/api/portal/aligment/all-alignments", "GET");
          ...
          break;
        case 'faqs':
          response = await fetchJSON("https://apihealthconnect.kopanovertex.com/api/portal/faq/all-faq", "GET");
          if (response.faqs) {
