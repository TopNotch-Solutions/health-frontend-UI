...
function Reporting() {
  ...
  const handleViewRecords = async (reportType) => {
    ...
    try {
      ...
      switch (reportType) {
        case 'users':
          response = await fetchJSON("http://13.51.207.99:4000/api/app/auth/all-users", "GET");
          ...
          break;
        case 'admins':
          response = await fetchJSON("http://13.51.207.99:4000/api/portal/auth/all-users", "GET");
          if (response.status === true && response.users) {
            data = response.users.map((user, index) => ({
              ...user,
              id: user._id || index,
          ...
          break;
        case 'transactions':
          response = await fetchJSON("http://13.51.207.99:4000/api/app/transaction/all-transactions", "GET");
          ...
          break;
        case 'issues':
          response = await fetchJSON("http://13.51.207.99:4000/api/app/issue/all-issues", "GET");
        ...
        case 'specializations':
          response = await fetchJSON("http://13.51.207.99:4000/api/portal/specialization/all-specializations", "GET");
          ...
          break;
        case 'ailments':
          response = await fetchJSON("http://13.51.207.99:4000/api/portal/aligment/all-alignments", "GET");
          ...
          break;
        case 'faqs':
          response = await fetchJSON("http://13.51.207.99:4000/api/portal/faq/all-faq", "GET");
          if (response.faqs) {
